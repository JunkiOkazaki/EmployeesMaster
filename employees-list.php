<html>
    ...
    <body>
        ...
        <!--ナビゲーションバー-->
        <ul>
            <li><a class="active" href="https://dev.jokazaki.net/employees-list.php">従業員一覧</a></li>
        ...
        <div class="mycontents">
            ...
            <!--入力欄-->
            <form method="post" autocomplete="off" action="employees-list-filter.php">
                ...
                <div  class="cp_iptxt"><select class="ef" name="department_name"><option label="部署名" hidden>部署名を選択</option><?php foreach($result2 as $rows2){?><option label="部署名" value="<?= htmlspecialchars($rows2['department_name']) ?>"><?= htmlspecialchars($rows2['department_name']) ?></option><?php } ?></select><span class="focus_line"></span></div>
