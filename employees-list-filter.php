    ...
    <body>
        ...
        <div class="mycontents">
                ...
                if (preg_match('/^[ぁ-んァ-ヶー一-龠]{1,10}+$/u', $department_name)) {
                    try {
                        ...
                        if (empty($result[0]['department_name'])) {
                            echo "<div class='error2'>部署名:&nbsp;" . $department_name . "&nbspは未登録です。<a href='https://dev.jokazaki.net/employees-master-manual.php#about2'>マニュアル</a>を参照し、登録済み部署の中から指定してください。</div>";
                        }
                    } catch (PDOException $Exception) {
                        die('接続エラー：' . $Exception->getMessage());
                        echo "データベース処理時にエラーが発生しました。";
            ...
            <form method="post" autocomplete="off" action="employees-list-filter.php">
                ...
                <input type="button" onclick="location.href = 'https://dev.jokazaki.net/employees-list.php'" value="「従業員一覧」に戻る" class="button">
                <br/>
