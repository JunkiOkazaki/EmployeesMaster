<html>
    ...
    <body>
        ...
        <!--ナビゲーションバー-->    
        <ul>
            <li><a class="active" href="https://dev-laravel.jokazaki.biz:8443/employees-list_l.php">従業員一覧</a></li>
        ...
        <div class="mycontents">
            ...
            <!--入力欄-->
            <form method="post" action="employees-list-filter_l.php">
                ...
                <input type="button" onclick="location.href = 'https://dev-laravel.jokazaki.biz:8443/employees-list_l.php'" value="「従業員一覧」に戻る" class="button">
                <br/>
                    ...
                    if (preg_match('/^[0-9]{1,4}$/', $department_id)) {
                        try {
                            ...
                            if (empty($result[0]['department_id'])) {
                                echo "<div class='error2'>部署ID:&nbsp;" . $department_id . "&nbspは未登録です。<a href='https://dev.jokazaki.biz:8443/employees-master-manual_l.php#about2'>マニュアル</a>を参照し、登録済み部署の中から指定してください。</div>";
                            }
                        } catch (PDOException $Exception) {
                            die('接続エラー：' . $Exception->getMessage());
                            echo "データベース処理時にエラーが発生しました。";
