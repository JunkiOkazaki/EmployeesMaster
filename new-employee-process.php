<html>
    ...
    <body>
        ...
        <ul>
            ...
            <li><a class="active" href="https://www.jokazaki.net/dev/new-employee.php">従業員登録</a></li>
        ...
        <div class="mycontents">
            ...
            <!--ボタン-->
            <input type="button" onclick="location.href = 'https://www.jokazaki.net/dev/new-employee.php'" value="「従業員登録」に戻る" class="button">
